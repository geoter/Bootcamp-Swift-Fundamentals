...
Iterate through `thirdListOfNumbers`, and print out the sum of all numbers and the sum of all the even numbers.
...
print("Total sum: \(totalSum)") // Total sum: 334
print("Sum of even numbers: \(evenSum)") // Sum of even numbers: 162 
```
